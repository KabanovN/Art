...
var accordion = function accordion(triggersSelector, blocksSelector) {
...
var burger = function burger(burgerSelector, menuSelector) {
  var burgerItem = document.querySelector(burgerSelector),
...
/***/ "./src/js/modules/checkInputText.js":
/*!******************************************!*\
  !*** ./src/js/modules/checkInputText.js ***!
  \******************************************/
/*! exports provided: default */
...
var checkInputText = function checkInputText(selector) {
...
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/requests */ "./src/js/modules/services/requests.js");
...
var forms = function forms(state) {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      var dots;
      var array = item.files[0].name.split('.');
      array[0].length > 6 ? dots = '...' : dots = '.';
      var name = array[0].substr(0, 7) + dots + array[1];
...
var sliders = function sliders(slidesSelector, direction, next, prev) {
  var slideIndex = 1,
  ...
  activateAnimation(); // при наведении родителя любого слайда - пауза
